...
import { renderDaily } from './views/daily.js?v=5';
import { renderInbox } from './views/inbox.js?v=5';
import { renderCheckin } from './views/checkin.js?v=5';
import { renderTimeline } from './views/timeline.js?v=5';
import { renderHistory } from './views/history.js?v=5';
import { renderReflection } from './views/reflection.js?v=5';
import { renderYfirlit } from './views/yfirlit.js?v=5';
import { renderVd } from './views/vd.js?v=5';
import { renderPersonal } from './views/personal.js?v=5';
